# 🏔️ Horizon Austral: Business Intelligence Dashboard
...
**Data Cleaning:** Resolución de conflictos de localización (puntos vs comas decimales) y normalización de formatos de datos.

**Modelado:** Creación de medidas DAX para KPIs clave como AOV (Average Order Value) y volumen de ventas mensual.

## 📊 Visualizaciones Clave

**Análisis de Mercados:** Gráfico de barras horizontales con la distribución de ingresos por país.
